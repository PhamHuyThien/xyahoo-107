...
public final class UIUtils
{
   ...
   public static final String generateTimestampString(String string) {
      String s2;
   ...
   public static void showTextInput(final Screen Screen, final TextInputComponent TextInputComponent) {
      ...
      TextInputComponent.posY = Screen.screenHeight - GameManager.footerHeight - (FontRenderer.fontHeight << 1);
   ...
   public static final String concatStrings(String string, final String str, final String str2, final String str3) {
      final StringBuffer sb;
   ...
   public static final void clearRecordStores(final boolean b) {
