...
public final class GameScreen extends Screen {
    ...
    public void removeMenuItem(String var1) {
    ...
    public void render(Graphics var1) {
        super.render(var1);
        if (isInGame) {
            FontRenderer.getFontInstance(FontRenderer.COLOR_WHITE).drawText(this.betDisplayText, 5, screenY + 3, var1);
    ...
    private void drawPlayerStatusIcon(Graphics var1, int var2, int var3, int var4, int var5, int var6) {
        if ((GameManager.instance.frameCounter >> 3) % 2 == 0) {
        ...
        var1.drawRegion(
                GameManager.avatarImage, var2, 0, var4, 35, 0, this.playerComponents[var6].baseX + (this.playerComponents[var6].isVerticalLayout ? (this.playerComponents[var6].position == 1 ? -50 : 21) : -31), screenY + this.statusIconY, 20
        );
    }
    ...
    public void showRoomList(GameRoom[] var1, int var2) {
        totalRooms = var2;
        ...
        if (this.roomGridComponent == null) {
            this.roomGridComponent = new GameRoomGridComponent(screenWidth - 3, screenHeight - 3 - GameManager.footerHeight, totalRooms);
        }
    ...
    public void initializeGameRoom(byte var1, String[] var2, long[] var3, int[] var4) {
        isInGame = true;
        totalRooms = 0;
        this.removeAllComponents();
        this.canStartGame = true;
        ...
        for (byte var12 = 0; var12 < var1; var12++) {
            ...
            if (var2[var8] != null) {
                ...
                CardInfo var11;
                if ((var11 = GameManager.instance.getCardInfoResource(var2[var8], 0)) != null) {
        ...
        if (!this.isBettingMode && this.betInputComponent == null) {
            ...
            this.betInputComponent.setBounds(0, screenHeight - GameManager.footerHeight - (FontRenderer.fontHeight << 1) - 10, screenWidth - 1, FontRenderer.fontHeight + 6);
    ...
    private void adjustScroll() {
        super.targetScrollY = -screenY + 2;
    }

    public String getNumberString(int var1) {
    ...
    public void startCardGame(byte[] var1, String var2, boolean var3, boolean var4) {
    ...
    public void handlePlayerMove(String var1, int var2, byte[] var3, String var4, boolean var5) {
        ...
        if (this.cardGameComponent != null && var6 != null) {
            ...
            this.cardGameComponent.startMoveAnimation(var3, var6.position == 1 ? screenWidth - var3.length * 14 - 35 : var6.baseX, var6.position == 1 ? (screenHeight >> 1) - 5 : var6.baseY);
    ...
    public void updatePlayerTurn(String var1, String var2, boolean var3) {
        super.needsUpdate = true;
    ...
    public void handleGameResult(String var1, byte var2, String[] var3, long[] var4, long[] var5, byte var6, String[] var7, byte[][] var8, int[] var9, CardInfo[] var10) {
    ...
    public void prepareFinalResults() {
        ...
        var1.copyInto(var4);
        this.playerComponents = GameManager.createPlayerComponents(var4);
    ...
    public void updateTurnWithHidden(String var1, String var2, boolean var3) {
        this.cardGameComponent.currentPlayer = var2;
        this.cardGameComponent.isWaiting = var3;
    ...
    private void initChatInput() {
        if (!this.isChatMode && this.chatInputComponent == null) {
            ...
            this.chatInputComponent.setBounds(0, screenHeight - GameManager.footerHeight - (FontRenderer.fontHeight << 1) - 10, screenWidth - 1, FontRenderer.fontHeight + 6);
    ...
    public static void showChatInput(GameScreen var0) {
        var0.showChatInput();
    }

    public static void showBetInput(GameScreen var0) {
        var0.showBetInput();
    }

    public static ContextMenu getLobbyMenu(GameScreen var0) {
        return var0.lobbyMenu;
    }

    public static ContextMenu getGameMenu(GameScreen var0) {
        return var0.gameMenu;
    }

    public static UIComponent getFocusedComponent(GameScreen var0) {
        return var0.focusedComponent;
    }

    public static void adjustScroll(GameScreen var0) {
        var0.adjustScroll();
    }
    ...
    public static TextInputComponent getBetInputComponent(GameScreen var0) {
