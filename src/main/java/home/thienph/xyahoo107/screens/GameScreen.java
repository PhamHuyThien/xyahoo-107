...
public final class GameScreen extends Screen {
   ...
   private UIFactory sendButton = new UIFactory(TextConstant.close(), new quyen_du(this));
   ...
   private void drawPlayerStatusIcon(Graphics var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      var1.drawRegion(
         GameManager.avatarImage, var2, 0, var4, 35, 0, 0 + this.playerComponents[var6].baseX + (this.playerComponents[var6].isVerticalLayout ? (this.playerComponents[var6].position == 1 ? -50 : 21) : -31), screenY + this.statusIconY, 20
      );
   }
