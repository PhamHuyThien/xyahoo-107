...
public final class LoginScreen extends DialogScreen {
    ...
    private final UIFactory registerButton = new UIFactory("Đăng ký", new quyen_ed(this));
    ...
    public LoginScreen() {
        ...
        super.centerSoftkey = new UIFactory("Đăng nhập", new LoginClickAction(this));
        super.title = " X Yahoo! ";
        ...
        var4 = screenWidth - (FontRenderer.getTextWidth("Đăng nhập ẩn") + 13 + 4) >> 1;
    ...
    public void showForgotPasswordSMS() {
        ...
        GameManager.instance.showConfirmDialog(UIUtils.concatStrings(var1, var2, null, null), new quyen_eh(this));
    }
    ...
    public void performLogin() {
        ...
        if (this.usernameInput.getText().equals("")) {
            ...
            PacketSender.e();
            GameManager.getInstance().createSimpleDialog(UIUtils.concatStrings("Đăng nhập với ", this.usernameInput.getText(), null, null), null, null, new UIFactory(TextConstant.close(), new quyen_ej(this))).setLoadingVisible(true);
