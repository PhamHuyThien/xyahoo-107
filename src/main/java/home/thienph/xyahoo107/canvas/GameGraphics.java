...
public final class GameGraphics extends Canvas implements Runnable {
    ...
    private static final boolean[] keyPressed = new boolean[21];
    private static final boolean[] keyRepeated = new boolean[21];
    private static final int[] charInput = new int[1];
