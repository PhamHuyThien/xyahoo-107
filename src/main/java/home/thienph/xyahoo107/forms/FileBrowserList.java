...
public final class FileBrowserList extends List implements CommandListener {
    ...
    public void showBrowser(final String title, final int d) {
    ...
    public byte getFileType(String lowerCase) {
    ...
    public boolean isSupportedFile(String lowerCase) {
        lowerCase = lowerCase.toLowerCase();
    ...
    public boolean isPngFile(final String s) {
        return hasExtension(s, new String[]{".png"});
    }

    public boolean isSupportedVideoFile(final String s) {
        final String[] d;
    ...
    public void setReturnScreen(final int m) {
        this.returnScreen = m;
    }
    ...
    public String getSelectedFilePath(final boolean b) {
        final String string;
        if ((string = this.getString(this.getSelectedIndex())).endsWith("/") || string.equals("..")) {
            return null;
        }
    ...
    public String parseFileExtension(String obj) {
        final String s = obj;
        final String s2 = "/";
        obj = s;
        ...
        if ((obj = array[1]).equalsIgnoreCase("mpeg")) {
            obj = ".mpg";
        } else if (obj.equalsIgnoreCase("3gpp")) {
            obj = ".3gp";
        } else if (obj.equalsIgnoreCase("3gpp2")) {
            obj = ".3g2";
        } else if (obj.equalsIgnoreCase("mpeg4")) {
            obj = ".mp4";
        } else {
            obj = "." + obj.toLowerCase();
        }
    ...
    public static String[] getSupportedVideoTypes() {
        ...
        for (int i = 0; i < length; ++i) {
            if (supportedContentTypes[i].length() != 5 && supportedContentTypes[i].substring(0, 5).equalsIgnoreCase("video")) {
                array[n] = i;
                ++n;
            }
        }
