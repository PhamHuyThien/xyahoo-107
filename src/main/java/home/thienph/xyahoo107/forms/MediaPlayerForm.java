...
import home.thienph.xyahoo107.actions.quyen_hv;
...
public final class MediaPlayerForm extends Form implements CommandListener, PlayerListener {
    ...
    private final Command backCommand = new Command(TextConstant.close(), 2, 1);
    private Command saveCommand;
    private final Command volumeCommand = new Command("Âm lượng", 1, 2);
    private final Command pauseCommand = new Command("Tạm ngưng", 1, 1);
    private final Command resumeCommand = new Command("Chơi tiếp", 1, 1);
    private final Command okCommand = new Command(TextConstant.back(), 2, 1);
    ...
    public void setReturnMode(int var1) {
        this.returnMode = var1;
    }

    public static MediaPlayerForm getInstance() {
        if (instance == null) {
    ...
    public MediaPlayerForm() {
        ...
        this.volumeForm.setItemStateListener(new VolumeChangeListener(this));
        this.volumeForm.setCommandListener(this);
        Display.getDisplay(Xuka.instance).setCurrent(this);
    }

    public void playMedia(byte[] var1, String var2) {
        String var4 = "";
        String var3;
        ...
        try {
            ...
            this.cleanup();
            GameManager.instance.showWrappedTextDialog("Điện thoại không hỗ trợ chức năng này");
        }
    }
    ...
    public static String getFileName(MediaPlayerForm var0) {
        return var0.fileName;
    }

    public static byte[] getMediaData(MediaPlayerForm var0) {
