...
import home.thienph.xyahoo107.actions.quyen_hz;
...
public final class SaveFileForm extends Form implements CommandListener {
    ...
    public static SaveFileForm getInstance() {
        if (instance == null) {
    ...
    public void commandAction(Command var1, Displayable var2) {
        if (var1.getLabel().equals(TextConstant.close())) {
            ...
            String var4 = this.formatChoiceGroup.getString(this.formatChoiceGroup.getSelectedIndex()).trim();
            ...
            if (var1 == this.saveCommand) {
                ...
                if (this.fileData != null) {
                    GameManager.instance.setUploadData(this.fullFileName, this.fileData, (byte) 1);
                ...
                if (var1 == this.previewCommand) {
                    if (this.fileData != null) {
                        GameManager.playMediaFile(this.fileData, this.fullFileName, false, 0);
                        return;
                    }
    ...
    public static String getFullFileName(SaveFileForm var0) {
