...
public final class GamePacketHandler extends PacketHandler {
    ...
    public void handlePacket(Packet var1, int var2) {
        ...
        switch (var2) {
            ...
            case 5000018:
                ...
                return;
            case 5000019:
                gameManager.blockUser(PacketUtils.readLong(var1), PacketUtils.readInt(var1));
                return;
            case 5000021:
            ...
            case 5000023:
                ...
                return;
            case 5000024:
                gameManager.removeFriend(PacketUtils.readLong(var1), PacketUtils.readInt(var1));
                return;
            case 5000026:
                if (PacketUtils.readBoolean(var1)) {
            ...
            case 5000035:
                ...
                return;
            case 5000036:
                gameManager.setEmptyContactMessage(PacketUtils.readString(var1));
                return;
            case 5000038:
                ...
                GameManager.instance.showWrappedTextDialog(PacketUtils.readString(var1));
                return;
            case 5000040:
            ...
            case 11712001:
                GameManager.instance.setLoadingState(false);
                gameManager.showAppInfo(PacketUtils.readString(var1));
                return;
            case 11712002:
                GameManager.instance.setLoadingState(false);
                GameManager.makePhoneCall(PacketUtils.readString(var1));
        }
    }
