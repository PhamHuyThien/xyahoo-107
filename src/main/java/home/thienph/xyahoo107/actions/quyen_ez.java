...
public final class quyen_ez implements Action {
    ...
    public void action() {
        if (GameManager.getInputHandler(this.a) == null || !GameManager.getInputHandler(this.a).isHelpTextEquals("Gửi góp ý")) {
            GameManager.setInputHandler(this.a, ButtonAction.createTextInputPopup(this.a.mainMenu, "Gửi góp ý", 0, new quyen_fa(this)));
        }

        UIUtils.showTextInputPopup(this.a.mainMenu, GameManager.getInputHandler(this.a));
    }
}
