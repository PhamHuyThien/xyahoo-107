...
public final class ListComponent extends UIComponent {
   ...
   private UIFactory emptyAction;
   private UIFactory multiSelectAction;
   ...
   public final void setIconSettings(int var1, int var2, int var3) {
      this.iconType = var1;
      this.iconWidth = var2;
      this.iconHeight = var3;
   }

   public final void setStatusIconType(int var1) {
   ...
   public final void setDataSource(DownloadDataManager var1, int var2, boolean var3) {
