...
public final class TextInputComponent extends UIComponent {
   ...
   private static String[] T9_CHARACTER_MAPS = new String[]{
      " 0",
      ".,@?!_1'/$-():*+<=>;%&#%^&*[];'/1",
   ...
   private static String[] CASE_LABELS = new String[]{"abc", "Abc", "ABC", "123"};
   ...
   private UIFactory clearAction = new UIFactory("Xóa", new quyen_ct(this));
   ...
   public final void deleteCharacterAtCursor() {
      if (this.currentText.length() == 1) {
         this.hideRightSoftKey();
      }

      if (this.cursorPosition > 0 && this.currentText.length() > 0) {
         this.currentText = this.currentText.substring(0, this.cursorPosition - 1) + this.currentText.substring(this.cursorPosition, this.currentText.length());
         this.cursorPosition--;
   ...
   private void insertTextAtCursor(int var1, String var2) {
      if (this.currentText.length() < this.maxLength) {
         ...
         if (this.cursorPosition < this.currentText.length()) {
            var3 = var3 + this.currentText.substring(this.cursorPosition, this.currentText.length());
         }
            ...
            if (var1 < 48 || var1 > 59) {
               ...
               if (this.useNativeInput) {
                  ...
                  if (var1 == this.lastKeyPressed) {
                     ...
                     if (this.cursorPosition < this.currentText.length()) {
                        var5 = var5 + this.currentText.substring(this.cursorPosition, this.currentText.length());
                     }
                     ...
                     if (this.cursorPosition < this.currentText.length()) {
                        var8 = var8 + this.currentText.substring(this.cursorPosition, this.currentText.length());
                     }
   ...
   public final void showHelpText(String var1) {
   ...
   public final boolean isHelpTextEquals(String var1) {
   ...
   private void updatePasswordMask() {
      if (this.inputConstraint == 2) {
         ...
         if (this.multiTapTimer > 0 && this.cursorPosition > 0) {
            this.maskedText = this.maskedText.substring(0, this.cursorPosition - 1) + this.currentText.charAt(this.cursorPosition - 1) + this.maskedText.substring(this.cursorPosition, this.maskedText.length());
         }
      }
   }
   ...
   public final void insertText(String var1) {
      if (var1 != null && var1.length() != 0) {
         this.showRightSoftKey();
   ...
   public final void setInputConstraint(int var1) {
