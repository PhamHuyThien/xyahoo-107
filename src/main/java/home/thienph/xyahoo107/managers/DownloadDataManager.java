...
public final class DownloadDataManager {
   ...
   public final boolean isDownloadExists(String var1, long var2) {
   ...
   public final DownloadCategory findCategoryById(String var1) {
   ...
   public final DownloadData findDownload(String var1, String var2, long var3) {
   ...
   public final void addDownloadToCategory(String var1, DownloadData var2) {
   ...
   public final void insertDownloadToCategory(String var1, DownloadData var2) {
   ...
   public final void removeDownload(String var1, long var2) {
   ...
   public final void updateDownloadStatus(String var1, long[] var2, String[] var3) {
      if (var2.length != 0) {
         int var4 = 0;
         int var5 = this.downloadCategories.size();
