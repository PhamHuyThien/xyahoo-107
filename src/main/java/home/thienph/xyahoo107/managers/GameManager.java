...
public final class GameManager {
   ...
   private Vector dialogQueue = new Vector();
   ...
   public final CardInfo getCardInfoResource(String var1, int var2) {
      DownloadData var3;
   ...
   public final DialogBox createDialog(String var1, int var2, Vector var3, int var4, UIFactory var5, UIFactory var6, UIFactory var7) {
   ...
   public final DialogBox createSimpleDialog(String var1, UIFactory var2, UIFactory var3, UIFactory var4) {
   ...
   public final boolean hasScreen(String var1) {
   ...
   public final boolean containsScreen(Screen var1) {
   ...
   public final UIFactory createBackButton(String var1) {
   ...
   public final UIFactory getSelectButton() {
   ...
   public final DialogBox showInfoDialog(String var1) {
      return this.createSimpleDialog(var1, null, this.createBackButton(TextConstant.close()), null);
   }

   public final DialogBox showConfirmDialog(String var1, Action var2) {
   ...
   public final void showOKDialog(String var1, Action var2) {
      this.createSimpleDialog(var1, null, new UIFactory("OK", var2), null);
   }

   public final void showWrappedTextDialog(String var1) {
   ...
   public final void switchToLastScreen() {
   ...
   public final boolean containsScreenInstance(Screen var1) {
      int var2 = this.screenCount;
   ...
   public final void showMessage(String var1) {
   ...
   public final boolean hasExceededReconnectLimit() {
      return this.reconnectCount > 3;
   }

   public final void resetConnectionCounters() {
   ...
   public final void showUpdateDialog(int var1, String var2) {
   ...
   public final void showSMSConfirmDialog(String var1, String var2, String var3) {
   ...
   public final void setSMSForPasswordReset(String var1, String var2) {
      this.smsNumber = var1;
      smsContent = var2;
      if (this.loginScreen != null) {
   ...
   public final void initializeFriendManager() {
      if (this.friendManager == null) {
   ...
   public final void setupMainMenu(DialogScreen var1) {
      this.closeDialog();
      this.mainMenu = var1;
   ...
   public final void replaceMainMenuItem(UIFactory var1, int var2) {
      if (this.mainMenuList != null) {
         this.mainMenuList.menuItems.setElementAt(var1, var2);
      }
   }

   public final void showAppInfo(String var1) {
      StringBuffer var2;
   ...
   public final void onYahooConnected() {
      this.resetConnectionCounters();
   ...
   public final void loadYahooBuddyList(DownloadDataManager var1) {
   ...
   public final void handleFriendRequestResponse(String var1, int var2) {
   ...
   public final void showPasswordChangeResult(boolean var1) {
      if (var1) {
   ...
   public final void addNotification(int var1, String var2, byte[] var3, int var4, int var5, String var6) {
      this.notificationTimer = 0;
   ...
   public final void processReceivedData(byte[] var1) {
   ...
   public final void setLoadingState(boolean var1) {
      this.isLoading = var1;
   }
   ...
   public final void updateUserAvatar(long var1, int[] var3) {
   ...
   public final void handleFileSendResponse(String var1, int var2) {
      this.closeDialog();
      if (var2 < 0) {
         this.cancelFileSend();
   ...
   public final void handleFileSendContinue(boolean var1) {
      if (var1) {
         this.continueFileSend();
      } else {
         this.cancelFileSend();
   ...
   public final void setUploadData(String var1, byte[] var2, byte var3) {
   ...
   public final void showPhotoViewer(byte[] var1, String var2, boolean var3, PhotoViewerScreen var4) {
      if (var3) {
   ...
   public final void showFileSizeConfirmDialog(int var1, Action var2, Action var3) {
   ...
   public final void startFileOperation(boolean var1) {
   ...
   public final void initializeMediaCapture(byte var1, byte var2) {
      if (this.fileManager == null) {
   ...
   public final void startDownload(String var1, String var2, int var3, byte var4) {
   ...
   public final void handlePlayerMoveWithState(String var1, String var2, int var3, byte[] var4, String var5, boolean var6, int var7) {
      if (GameScreen.currentRoomId.equals(var1)) {
         updateSpecialModeText(var2);
   ...
   public final void handlePlayerLeaveRoom(String var1, String var2, String var3, String[] var4, String var5) {
   ...
   public final void joinGameRoom(String var1, long var2, String[] var4, long[] var5, int[] var6, boolean[] var7, String var8) {
   ...
   public final void showMoneyNotification(long var1) {
   ...
   public final void updateUserProfile(long var1, long[] var3, int var4) {
      if (this.friendManager != null) {
   ...
   public final void loadSecondaryContactsMode3(DownloadDataManager var1) {
   ...
   public final void setBlockedUsers(long[] var1) {
      if (this.friendManager != null && var1 != null) {
         FriendScreen.setVectorFromArray(var1, this.friendManager.blockedUsers);
      }
   }

   public final void loadSecondaryContactsMode2(DownloadDataManager var1) {
   ...
   public final void storeUserAndProcessInvite(long var1, String var3) {
   ...
   public final void openChatWithUser(long var1, String var3) {
      this.friendManager.storeUserData(var1, var3);
      ChatScreen var4;
   ...
   public final void handleFriendAccepted(long var1, String var3, int var4, int var5) {
      if (this.friendManager != null) {
         if (this.friendManager.isUserBlocked(var1)) {
   ...
   public final void removeFriend(long var1, int var3) {
      if (this.friendManager != null) {
   ...
   public final void blockUser(long var1, int var3) {
      if (this.friendManager != null) {
         FriendScreen.removeContactFromList(var1, this.friendManager.mainContactList);
         this.friendManager.removeFromOnlineList(var1);
   ...
   public final void receiveMessage(long var1, String var3) {
      if (!this.friendManager.isUserBlocked(var1)) {
         String var4;
   ...
   public final ChatScreen getOrCreateChatScreen(String var1) {
      ChatScreen var2;
   ...
   public final void handleUserStatusChange(long var1, int var3) {
   ...
   public final void updateUserStatusMessage(long var1, String var3) {
   ...
   public final void showOfflineMessages(DownloadDataManager var1) {
   ...
   public final void showChatWithMessages(String var1, Vector var2, long var3) {
      ChatScreen var6;
   ...
   public final void handleChatRoomInvite(String var1, String var2, long var3) {
   ...
   public final void joinChatRoom(String var1, String var2, long var3) {
   ...
   public final void showChatRoomInviteDialog(String var1, String var2, String var3, String var4) {
   ...
   public final void receiveChatRoomMessage(String var1, String var2, int var3) {
