...
public final class quyen_ec extends DialogScreen {
   ...
   ContextMenu E;
   private int G;
   private UIFactory H = new UIFactory("Đăng ký", new quyen_ed(this));
   private static DialogScreen I;

   public final void render(Graphics var1) {
      super.render(var1);
      FontRenderer.getFontInstance(FontRenderer.COLOR_WHITE).drawText(GameManager.version, this.G, Screen.screenY + 3, var1);
   }

   public quyen_ec() {
      this.G = Screen.screenWidth - FontRenderer.getTextWidth(GameManager.version) - 6;
      Vector var1;
      ...
      this.a.marginOffset = -5;
      this.b.marginOffset = -5;
      super.nextComponentY += 6;
      TextComponent var5 = new TextComponent("Tài khoản:", UIUtils.leftColumnX, super.nextComponentY, FontRenderer.fontHeight);
      this.D = new DropdownComponent(new String[]{"Xubi", "Yahoo!"}, UIUtils.rightColumnX, super.nextComponentY - 3, UIUtils.rightColumnWidth, FontRenderer.fontHeight + 6);
      this.D.setSelectedIndex(var4);
      this.D.changeAction = new quyen_eo(this);
      this.addComponent(var5);
      this.addComponent(this.D);
      super.nextComponentY += 3;
      var4 = Screen.screenWidth - (FontRenderer.getTextWidth("Đăng nhập ẩn") + 13 + 4) >> 1;
      this.d = new CheckboxComponent("Đăng nhập ẩn", var4, super.nextComponentY, FontRenderer.getTextWidth("Đăng nhập ẩn") + 13 + 4, FontRenderer.fontHeight + 4);
      this.d.isChecked = Xuka.loadBooleanSetting("status", false);
      this.addComponent(this.d);
      super.nextComponentY += 4;
      super.dialogX = Screen.screenWidth - FontRenderer.getTextWidth("Đăng ký tài khoản") >> 1;
      UIFactory.createCustomButton(this, "Đăng ký tài khoản", -1, this.H.action, super.dialogX, super.nextComponentY, super.dialogWidth);
      UIUtils.focusComponent(this, (UIComponent)this.a);
      this.F = new Vector();
      this.F.addElement(this.H);
      this.F.addElement(new UIFactory("Quên mật khẩu?", new quyen_ep(this)));
      this.F.addElement(new UIFactory("Cấu hình", new quyen_eq(this)));
      this.F.addElement(var2);
      this.F.addElement(new UIFactory("Thoát", new quyen_er(this)));
   ...
   public static void a() {
      if (I == null) {
         System.gc();
         (I = new DialogScreen()).title = "Cấu Hình";
         I.nextComponentY += 14;
         DropdownComponent var0 = UIFactory.createChoiceBox(I, "Tốc độ phím: ", new String[]{"1", "2", "3", "4", "5", "6", "7"});
         CheckboxComponent var1 = UIFactory.createCheckbox(I, "Âm thanh", !GameManager.soundEnabled);
         CheckboxComponent var2 = UIFactory.createCheckbox(I, "Rung", GameManager.vibrateEnabled);
         CheckboxComponent var3 = UIFactory.createCheckbox(I, "Tự đăng nhập", GameManager.autoLogin);
         CheckboxComponent var4 = UIFactory.createCheckbox(I, "Tự đăng nhập Yahoo!", GameManager.autoLoginYahoo);
         UIFactory.createButton(I, UIUtils.concatStrings("Xóa", " dữ liệu cá nhân", null, null), new quyen_ee(), I.nextComponentY + 2, 0);
         var0.setSelectedIndex(TextInputComponent.inputModeIndex);
         UIUtils.focusComponent(I, var0);
         ...
         I.rightSoftkey = new UIFactory(quyen_cr.c(), new quyen_ef(var2, var5, var1, var6, var3, var7, var4, var8, var0, var9));
         I.centerSoftkey = new UIFactory("Lưu", new quyen_eg(var3, var4, var0, var2, var1));
      }

      GameManager.getInstance().addScreenToStack((Screen)I);
      I.startSlideAnimation(-1);
      GameManager.getInstance().o();
   }

   public final void h() {
      String var1;
      String var2 = UIUtils.concatStrings(var1 = UIUtils.concatStrings("Bạn sẽ nhận mật khẩu qua tin nhắn.", "\n", "Gửi tin: ", GameManager.smsContent), this.a.getText(), Xuka.refCode, "\nĐến số: ");
