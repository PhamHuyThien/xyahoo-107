...
public final class DownloadScreen extends Screen {
   ...
   public DownloadScreen() {
      ...
      super.title = "Tải Về";
      this.downloadListComponent = new ListComponent(0, 0, Screen.screenWidth, Screen.screenHeight - GameManager.footerHeight);
      ...
      super.rightSoftkey = GameManager.a(this, false, null);
   ...
   public final void deleteDownloadsByType(byte var1) {
      int var2 = 0;
