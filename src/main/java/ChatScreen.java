...
public final class ChatScreen extends Screen {
   ...
   static UIFactory getSendButton(ChatScreen var0) {
      return var0.sendButton;
   }

   static String getYahooContactId(ChatScreen var0) {
      return var0.yahooContactId;
   }

   static Vector getMenuItems(ChatScreen var0) {
      return var0.menuItems;
   }

   static ContextMenu getContextMenu(ChatScreen var0) {
