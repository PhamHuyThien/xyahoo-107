...
public final class GridComponent extends UIComponent {
   private Integer[] itemImageIds;
   private int[] itemDataIds;
   private Vector itemTextLines;
   private int itemSpacingX;
   private int itemHeaderHeight;
   private int totalItemCount;
   private int gridStartX;
   private int gridStartY;
   private int itemFullHeight;
   private int scrollRowsNeeded;
   ...
   private int displayMode; // độ hiển thị (1 hoặc 2 dòng text), 80%
   ...
   public final boolean handleKeyPress(int i) {
      boolean b = true;
      switch (i) {
         case 14: {
