...
public final class CardGameComponent extends UIComponent {
   ...
   public final void initializeHand(byte[] var1) {
      handCards = null;
      selectedCards = null;
   ...
   public final void selectAllCards() {
      for (int var1 = 0; var1 < handCardCount; var1++) {
         selectCard(var1);
      }
   }

   public final void deselectAllCards() {
      for (int var1 = 0; var1 < handCardCount; var1++) {
   ...
   public final void removeCards(byte[] var1) {
      int var2 = 0;
   ...
   public final void startMoveAnimation(byte[] var1, int var2, int var3) {
      this.animationCards = null;
      System.gc();
   ...
   public final void setupOtherPlayersView() {
   ...
   private boolean validateMove(Card[] var1) {
      ...
      if (!this.gameEnded && FriendScreen.currentUserId.equals(this.currentPlayer)) {
         ...
         boolean var12 = false;
         boolean var15 = false;
         if (var9.length == 8 && this.isDoubleStraight(var9, 0)) {
            var15 = true;
         }
   ...
   private boolean isDoubleStraight(int[] var1, int var2) {
      ...
      if (var1.length % 2 == 0) {
         ...
         if (this.isStraight(var5, var2) && this.isStraight(var6, var2) && (var8 = var5[0]) >> 2 == (var9 = var6[0]) >> 2) {
            var3 = true;
            if (var2 == 1 && !this.isOppositeColor(var5[0], var6[0])) {
               var3 = false;
            }
         }
      }
