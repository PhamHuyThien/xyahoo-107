...
public final class YahooScreen extends Screen {
   private static Integer YAHOO_LOGO_INDEX = new Integer(1);
   ...
   TextInputComponent searchInput;
   public boolean isConnectionReady;
   private TextComponent yahooIdLabel;
   public TextInputComponent usernameInput;
   private TextComponent passwordLabel;
   public TextInputComponent passwordInput;
   public CheckboxComponent invisibleCheckbox;
   private TextComponent domainLabel;
   DropdownComponent domainDropdown;
   private int logoX;
   private int logoY;
   ...
   public final void switchToMode(boolean var1) {
   ...
   protected final void performLogin() {
      if (GameManager.instance.w()) {
         GameManager.instance.d("Tài khoản Yahoo của bạn bị khóa. Vui lòng đăng nhập lại sau.");
      } else {
         ...
         if (var1.equals("")) {
            ...
            this.buddyListRequestId = GameManager.a(true);
   ...
   public final void showInviteFriendDialog() {
      ...
      GameManager.getInstance().a("Mời bạn Yahoo! dùng X Yahoo!", new quyen_ji(this));
   }

   static boolean checkConnectionReady(YahooScreen var0) {
   ...
   static void showStatusDialog(YahooScreen var0) {
      if (isInvisibleLogin) {
   ...
   static void exitSearchMode(YahooScreen var0) {
      var0.exitSearchMode();
   }

   static TextInputComponent getActiveTextInput(YahooScreen var0) {
      return var0.activeTextInput;
   }

   static void setActiveTextInput(YahooScreen var0, TextInputComponent var1) {
      var0.activeTextInput = var1;
   }

   static TextInputComponent getStatusMessageInput(YahooScreen var0) {
      return var0.statusMessageInput;
   }

   static DropdownComponent getStatusDropdown(YahooScreen var0) {
   ...
   static DialogScreen getStatusScreen(YahooScreen var0) {
