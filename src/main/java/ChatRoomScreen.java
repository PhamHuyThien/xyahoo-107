...
public final class ChatRoomScreen extends DialogScreen {
   ...
   private UIFactory backSoftkey = new UIFactory(TextConstant.close(), new quyen_q(this));
   ...
   public ChatRoomScreen(String var1, String var2, boolean var3) {
      ...
      this.textInputComponent.setBounds(1, Screen.screenHeight - GameManager.footerHeight - FontRenderer.paragraphSpacing - 1, Screen.screenWidth - 3, FontRenderer.fontHeight + 6);
      ...
      this.chatComponent = new ChatComponent(0, 0, Screen.screenWidth, Screen.screenHeight - (GameManager.footerHeight + FontRenderer.paragraphSpacing));
   ...
   public final void hideWelcomeAndShowChat() {
   ...
   static UIFactory getBackSoftkey(ChatRoomScreen var0) {
      return var0.backSoftkey;
   }

   static ContextMenu getContextMenu(ChatRoomScreen var0) {
